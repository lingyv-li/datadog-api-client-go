...
func (r *SearchDashboardsOptionalParameters) WithWithSuggestedtrue(withSuggestedtrue bool) *SearchDashboardsOptionalParameters {
	r.WithSuggestedtrue = &withSuggestedtrue
	return r
}
...
This query will not return preset dashboards.
*/
func (a *DashboardsApiService) SearchDashboards(ctx _context.Context, start int64, count int64, o ...SearchDashboardsOptionalParameters) (DashboardSearchSummary, *_nethttp.Response, error) {
	req := apiSearchDashboardsRequest{
		ApiService: a,
		ctx:        ctx,
		start:      &start,
		count:      &count,
	...
	if len(o) > 1 {
		var localVarReturnValue DashboardSearchSummary
		return localVarReturnValue, nil, reportError("only one argument of type SearchDashboardsOptionalParameters is allowed")
	}

	if o != nil {
		req.withSuggestedtrue = o[0].WithSuggestedtrue
		req.query = o[0].Query
		req.sort = o[0].Sort
	}

	return req.ApiService.searchDashboardsExecute(req)
}

/*
 * Execute executes the request
 * @return DashboardSearchSummary
 */
func (a *DashboardsApiService) searchDashboardsExecute(r apiSearchDashboardsRequest) (DashboardSearchSummary, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  DashboardSearchSummary
	)
	...
	localVarPath := localBasePath + "/api/v1/dashboard_search"
	...
	if r.withSuggestedtrue != nil {
		localVarQueryParams.Add("with_suggested&#x3D;true", parameterToString(*r.withSuggestedtrue, ""))
	}
	if r.query != nil {
	...
	// Set Operation-ID header for telemetry
	localVarHeaderParams["DD-OPERATION-ID"] = "SearchDashboards"
