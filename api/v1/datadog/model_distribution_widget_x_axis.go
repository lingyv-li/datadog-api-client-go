...
type NullableDistributionWidgetXAxis struct {
	value *DistributionWidgetXAxis
	isSet bool
}

func (v NullableDistributionWidgetXAxis) Get() *DistributionWidgetXAxis {
	return v.value
}

func (v *NullableDistributionWidgetXAxis) Set(val *DistributionWidgetXAxis) {
	v.value = val
	v.isSet = true
}

func (v NullableDistributionWidgetXAxis) IsSet() bool {
	return v.isSet
}

func (v *NullableDistributionWidgetXAxis) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDistributionWidgetXAxis(val *DistributionWidgetXAxis) *NullableDistributionWidgetXAxis {
	return &NullableDistributionWidgetXAxis{value: val, isSet: true}
}
